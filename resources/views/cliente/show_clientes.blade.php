            ...
            <table class="w-full border-collapse bg-white shadow-md rounded-lg">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-100">
                        <td class="p-3"><a href="{{ route('clientes.show', $cliente->id) }}">{{ $cliente->nome }}</a></td>
                        ...
                        <td class="p-3 flex"> 
                            <a class="text-blue-600 hover:underline pe-2" href="{{ route('clientes.edit', $cliente->id) }}">Editar</a>
                            <form class="text-blue-600 hover:underline" action="{{ route('clientes.destroy', $cliente->id) }}" method="post">
                                @csrf
                                {{ method_field('DELETE') }}
